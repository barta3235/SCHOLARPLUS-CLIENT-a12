        ...
        <section className="py-2 dark:bg-gray-100 dark:text-gray-900 mx-[5px] md:mx-[50px] mb-[100px]">
            <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x tracking-wider">
                <div className="py-6 md:py-0 md:px-6">
                    <h1 className="text-4xl font-semibold mb-4">Have questions? <span className="border-b-[3px] border-b-yellow-300">Contact us!</span></h1>
                ...
                <form onSubmit={handleSubmit} noValidate="" className="flex flex-col py-6 space-y-6 md:py-0 md:px-6">
                    <label className="block">
                        ...
                        <input name="name" type="text" placeholder="Leroy Jenkins" className="block w-full rounded-md shadow-sm shadow-yellow-300 py-2 pl-2" />
                    </label>
                    <label className="block">
                        <span className="mb-2 font-medium">Email address</span>
                        <input name="email" type="email" placeholder="leroy@jenkins.com" className="block w-full shadow-yellow-300 rounded-md shadow-sm py-2 pl-2" />
                    </label>
                    <label className="block">
                        <span className="mb-2 font-medium">Message</span>
                        <textarea rows="4" name="message" className="block w-full shadow-yellow-300 rounded-md border shadow-sm" ></textarea>
                    </label>
