                        ...
                        < div className="container py-12 " >
                            <div className="grid items-center gap-4 xl:grid-cols-5">
                                <div className="max-w-2xl mx-auto my-8 space-y-4 text-center xl:col-span-2 xl:text-left tracking-wider">
                                    <h2 className="text-3xl md:text-[40px] font-medium flex gap-5 tracking-wider"><h1 className="flex items-center gap-2"><span>Scholar</span><FaPlus className="text-yellow-300" /></h1> <span className="border-b-yellow-300 border-b-[3px] pb-2">reviews</span></h2>
