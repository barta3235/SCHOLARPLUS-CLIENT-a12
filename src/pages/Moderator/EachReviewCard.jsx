...
const EachReviewCard = ({ eachReview, refetch }) => {
    ...
    const handleDelete = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const res = await axiosSecure.delete(`/user/moderator/allReviewDelete/${id}`)
    ...
    return (
        <div className="flex flex-col max-w-lg p-3 overflow-x-auto rounded-lg shadow-lg border dark:bg-gray-50 dark:text-gray-800 ">
