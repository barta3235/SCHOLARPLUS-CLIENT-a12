...
const ManageScholarship = () => {
    ...
    const handleDelete = (id) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const res1 = await axiosSecure.delete(`/user/moderator/allScholarship/${id}`)
    ...
    const handleUpdate = async (id) => {
        const res2 = await axiosSecure.get(`/user/moderator/allScholarship/${id}`)
    ...
    const handleUpdate2=async(e)=>{
        ...
        const res3=await axiosSecure.put(`/user/moderator/allScholarship/${id}`,updatedScholarship)
